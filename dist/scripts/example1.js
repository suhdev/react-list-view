...
$__System.register('cc', ['a6', 'b2', 'b5', 'b6', 'cb'], function (_export) {
    var _get, _inherits, _createClass, _classCallCheck, React, ListItem;
...
$__System.register('cd', [], function (_export) {
    'use strict';
...
$__System.register('ce', ['99', 'a6', 'b2', 'b5', 'b6', 'cb', 'cc', 'cd'], function (_export) {
    var ReactDOM, _get, _inherits, _createClass, _classCallCheck, React, ListItem, debounce, ListView;
    ...
    return {
        setters: [function (_) {
            ...
            ListItem = _cc.ListItem;
        }, function (_cd) {
            debounce = _cd.debounce;
        }],
        execute: function () {
            'use strict';
            ...
            ListView = (function (_React$Component) {
                ...
                _createClass(ListView, [{
                    ...
                    value: function onScroll() {
                        var count = this.props.getItemCount(),
...
$__System.register('1', ['99', 'cb', 'ce'], function (_export) {
    'use strict';

    var ReactDOM, React, ListView, items, i;
    return {
        setters: [function (_) {
            ReactDOM = _;
        }, function (_cb) {
        ...
        execute: function () {
            ...
            ReactDOM.render(React.createElement(ListView, { onItemClick: function onItemClick(e) {}, itemHeight: 54, maxHeight: 300, getItemCount: function getItemCount() {
                    return items.length;
                }, getDefForItem: function getDefForItem(idx) {
                    return items[idx];
